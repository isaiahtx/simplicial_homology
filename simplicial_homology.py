...
def main():
    #simp_hom(big_to_small([[0,1,2,3],[0,1,2],[0,1,3],[0,2,3],[1,2,3],[3,4],[1,4],[5,6]]))
    #simp_hom(big_to_small([[0,4,5], [0,1,5], [1,3,5], [0,3,4], [0,2,3], [0,1,2], [1,2,4], [1,3,4], [2,4,5], [2,3,5]]))
    #simp_hom(big_to_small([[0,1],[1,2],[2,0]]))
    simp_hom(big_to_small([[0,1,6],[1,6,7],[1,2,7],[2,7,8],[0,2,8],[0,3,8],[3,6,7],[3,4,7],[4,7,8],[4,5,8],[3,5,8],[3,5,6],[0,3,4],[0,1,4],[1,4,5],[1,2,5],[2,5,6],[0,2,6],[9,10,11],[9,10,12],[9,11,12],[10,11,12]]))
